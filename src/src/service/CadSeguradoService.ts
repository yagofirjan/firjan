...
const SELECT_QUERY: string = '$select=ID,Nome,CPF,DataNascimento,Matricula,Empresa,Login,Estabelecimento,Lotacao,Estado,DataAssinatura,Assinatura,Status,Motivo,Author/ID,Author/Title,AttachmentFiles/ServerRelativeUrl,AttachmentFiles/Title&$expand=Author/ID,Author/Title,AttachmentFiles/ServerRelativeUrl,AttachmentFiles/Title';
