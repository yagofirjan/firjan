        ...
        if (item.Status == "Pendente Gap") {
            ...
            HtmlItensTable += `<tr id="VR${item.ID}">
                              ...
                              <td class="${styles.tbtd}"id="TdOptions${item.ID}">
                                  ...
                                  <button class="${styles.BtnOptionsCancel} SPVOptionsCancel" title="Cancelar Solicitação" id="SPVOptionsCancel${item.ID}" >     
                                  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-x-square" viewBox="0 0 16 16">
          ...
          if (item.Status == "Reprovado") {
            ...
            HtmlItensTable += `<tr id="VR${item.ID}">
                              ...
                              <td class="${styles.tbtd}"id="TdOptions${item.ID}">
                                ...
                                <button class="${styles.BtnOptionsMotivo} SPVOptionsMotivo" title="Vizualizar Motivo" id="SPVOptionsMotivo${item.ID}" >     
